  ...
  return (
    <section className="relative flex flex-col items-center overflow-hidden px-4 pt-36 pb-16 text-center md:px-8 md:pt-44 md:pb-24">
      ...
      <div className="relative z-10 mx-auto flex max-w-5xl flex-col items-center">
        <span className="text-primary inline-flex items-center gap-2 rounded-full border border-neutral-200 bg-white/80 px-3 py-1.5 text-[11px] font-semibold tracking-[0.16em] uppercase shadow-sm backdrop-blur-sm">
          <Sparkles className="h-3.5 w-3.5" />
          The all-in-one company operating system
        </span>

        <h1 className="mt-8 text-4xl leading-[1.05] font-semibold tracking-tight text-neutral-950 md:text-6xl lg:text-7xl">
          Your company,
        ...
        <p className="mt-6 max-w-2xl text-base leading-relaxed text-neutral-600 md:text-xl">
        ...
        <div className="mt-10 flex flex-col items-center gap-4 sm:flex-row">
          ...
          <Button
            size="lg"
            variant="outline"
            className="h-12 rounded-full border-neutral-300 bg-white/50 px-8 text-base backdrop-blur-sm hover:bg-white"
            asChild
          >
        ...
        <div className="mt-10 flex flex-wrap justify-center gap-3 text-sm text-neutral-600">
          {[
            ...
            <div
              key={item}
              className="inline-flex items-center gap-2 rounded-full border border-neutral-200/80 bg-white/70 px-4 py-2 shadow-sm backdrop-blur-sm transition-all hover:bg-white hover:shadow-md"
            >
      ...
      <div className="relative z-10 mx-auto mt-20 w-full max-w-6xl">
        ...
        <div className="relative rounded-2xl border border-neutral-200/50 bg-white/30 p-2 shadow-2xl backdrop-blur-md lg:p-4">
          <div className="overflow-hidden rounded-xl border border-neutral-100 bg-white shadow-inner">
            <img
